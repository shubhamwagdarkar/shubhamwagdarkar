...
| [ci-cd-health-scorecard](https://github.com/shubhamwagdarkar/ci-cd-health-scorecard) | DORA metrics across Jenkins + GitHub Actions with interactive HTML trend reports | Python · pandas · plotly |
